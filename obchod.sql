...
-- tabulky
create table zakaznik(zakaznik_id int primary key auto_increment not null, jmeno varchar(100) not null, prijmeni varchar(100) not null, email varchar(100), telefon int(20) not null, adresa varchar(150));
...
-- tabulky
 ...
 insert into zakaznik(jmeno, prijmeni, email, telefon, adresa) values ('Petr', 'Novák', 'petrnov@gmail.com', 456159753, 'Praha, Vodičkova');
...
objednavka.datum as 'Datum',
 zakaznik.jmeno as 'Zakaznik jmeno',
 zakaznik.prijmeni as 'zakaznik prijmeni',
 zakaznik.telefon as 'Zakaznik telefon',
 zbozi.cena as 'Cena',
